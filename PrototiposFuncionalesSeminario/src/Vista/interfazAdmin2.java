 ...
 * @author carli
 */
public class InterfazAdmin2 extends javax.swing.JFrame {

    /**
     * Creates new form interfazAdmin2
     */
    public InterfazAdmin2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazAdmin2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAdmin2().setVisible(true);
            }
        });
    }
